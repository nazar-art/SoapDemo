...
public interface GeoIPServiceSoap {
     ...
     *
     * @param ipAddress
     * @return returns org.lelyak.demo.webservices.GeoIP
     */
    ...
    @RequestWrapper(localName = "GetGeoIP", targetNamespace = "http://www.webservicex.net/", className = "org.lelyak.demo.webservices.GetGeoIP")
    @ResponseWrapper(localName = "GetGeoIPResponse", targetNamespace = "http://www.webservicex.net/", className = "org.lelyak.demo.webservices.GetGeoIPResponse")
    ...
    @RequestWrapper(localName = "GetGeoIPContext", targetNamespace = "http://www.webservicex.net/", className = "org.lelyak.demo.webservices.GetGeoIPContext")
    @ResponseWrapper(localName = "GetGeoIPContextResponse", targetNamespace = "http://www.webservicex.net/", className = "org.lelyak.demo.webservices.GetGeoIPContextResponse")
